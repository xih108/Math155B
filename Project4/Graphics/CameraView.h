...
public:
    ...
    CameraView& SetFromAABB(const AABB& boundingbox, double fovy);

    virtual bool CameraViewHasBeenSet() const { return DistanceHasBeenSet; }
    virtual void Unset() { DistanceHasBeenSet = false;  }
    ...
    void MoveCameraView(const VectorR3& displacement);
    void MoveToAndFrom(double distanceDelta);
...
public:
	...
	void SetClippingDistances( double nearClippingDistance, double farClippingDistance);
...
inline void CameraView::SetClippingDistances( double nearClippingDistance, double farClippingDistance)
{
	NearClippingDist = nearClippingDistance;
	FarClippingDist = farClippingDistance;
}
