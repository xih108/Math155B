...
void my_setup_SceneData() {
    ...
    unsigned int shader_vert = GlShaderMgr::CompileShader("vertexShader1_PhongPhong");
    unsigned int shader_frag = GlShaderMgr::CompileShader("fragmentShader1_PhongPhong", "calcPhongLighting", "applyTextureMap");
